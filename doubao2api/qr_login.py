"""
QR code login for Doubao (豆包).

Ported from LiveSub's QRLogin.cpp. Runs the full QR login flow
...
class QRLogin:
    """
    Doubao QR code login, ported from LiveSub ``QRLogin.cpp``.
